...
const BestDeals = () => {
    return (
        <div >
            <div >
                <img className='mx-auto' src="https://i.ibb.co/5hSvW6m/pexels-neil-kelly-712614-removebg-preview.png" alt="" />
            </div>
            {/*  */}
            <div className='grid grid-cols-1 lg:grid-cols-2 my-5 gap-10 px-5 md:px-10 lg:ml-10 '>
                <div className='space-y-5 mx-auto mb-16 md:mb-0'>
                ...
                <div className='space-y-5'>
                    <div className='flex flex-col md:flex-row items-center gap-5'>
                        ...
                        <div>
                            ...
                            <p className='text-neutral-500  text-sm'>Take your driving experience to the next level with our top-notch vehicles for your cross-country.Take your driving experience to the next level with our top-notch vehicles for your cross-country</p>
                        </div>
                    </div>
                    <div className='flex flex-col md:flex-row items-center gap-5'>
                        <div>
